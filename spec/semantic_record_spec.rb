...
describe Genre do
 it "should respond to various methods" do
  ...
  it "should return an array of objects" do   
    ...
    genres[0].uri.first.should eql("http://example.org/music#Funk")
    genres[1].should be_an_instance_of(Genre)
    genres[1].uri.first.should eql("http://example.org/music#Rock")
    
    funk = Genre.find(:first)
    funk.first.uri.first.should eql("http://example.org/music#Funk")
  ...
  it "should find Jazz by Jon" do
    ...
    g.first.uri.first.should eql("http://example.org/music#Jazz")
  end
  ...
  it "should have exact 1 instance of genre with uri http://example.org/music#Jazz" do
    ...
    jazz[0].uri.first.should eql("http://example.org/music#Funk")
  end
